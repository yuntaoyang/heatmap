...
#---- heatmap function ---------------------------------------------------------
heatmap <- function(matrix,condition,color_heatmap,color_group,file_name,width,height,show_row_names,cluster_rows,cluster_columns)
{
...
#---- heatmap ------------------------------------------------------------------
heatmap(matrix,condition,color_heatmap,color_group,file_name,width,height,show_row_names,cluster_rows,cluster_columns)
